...
public:
	...
	std::vector<std::vector<H3DBox> > tree;	//	The tree storing all the information.
...
// public:
H3DTree(kerneltype* K, int cubeRootN, int nLevels, int nParticlesInLeafAlong1D, double L, int TOL_POW) {
	this->K					=	K;
